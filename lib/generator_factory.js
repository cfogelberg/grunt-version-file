...
GeneratorFactory.prototype.create = function(generator_config) {
  var is_valid_generator_config = function(gc) {
    if(!(gc && gc.value && gc.value instanceof Function && gc.label && gc.label instanceof Function)) {
      return false;
    }
    else {
      var fields = Object.keys(gc);
      var initIndex = fields.indexOf("init");
      return fields.length === 2 || (fields.length === 3 && initIndex !== -1 && gc.init instanceof Function);
    }
  };
